...
![雙邊市場飛輪：供給端與需求端透過平台互相媒合，形成正向循環](/media/articles/two-sided-marketplace/flywheel-zh.svg)
...
![平台的兩個客戶：司機端在乎每小時收入，乘客端在乎多快叫到車，兩端需求常互相矛盾](/media/articles/two-sided-marketplace/two-customers-zh.svg)
...
![市場流動性的三個層次：總量平衡、時間平衡、空間平衡](/media/articles/two-sided-marketplace/liquidity-levels-zh.svg)
...
![乘客端漏斗與司機端漏斗並排比較，各自標出每個階段的流失原因](/media/articles/two-sided-marketplace/funnels-zh.svg)
...
![動態定價的雙邊效果：漲價一方面延後乘客需求，一方面吸引更多司機上線](/media/articles/two-sided-marketplace/pricing-effect-zh.svg)
...
![雙邊監控儀表板三層架構：北極星、健康度、預警](/media/articles/two-sided-marketplace/dashboard-layers-zh.svg)
...
![雙邊市場分析完整流程：建立框架、理解流動性、拆解漏斗、雙邊分群、動態調節、持續監控](/media/articles/two-sided-marketplace/conclusion-flow-zh.svg)

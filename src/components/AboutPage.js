...
const copy = {
  zh: {
    ...
    facts: [
      ["CURRENT", "WSP Data & AI Consultant"],
      ["MARKETS", "台灣 · 德國 · 香港 · 中國大陸"],
      ["LANGUAGES", "三文五語"],
      ["OUTSIDE WORK", "教學 · 寫作 · 城市散步"],
    ],
    ...
    storyBody: [
      ...
      "回到亞洲後，我帶過 Data & AI 團隊、做過模型與平台，也走進客戶的會議室。現在最在意的，是讓策略、資料與人的日常工作真正接得起來。",
    ...
    ctaKicker: "SAY HELLO",
    ctaTitle: "想聊 Data & AI，或只是交換一段異地生活？",
    ctaButton: "寫信給我",
    present: "現在",
    close: "關閉",
  },
